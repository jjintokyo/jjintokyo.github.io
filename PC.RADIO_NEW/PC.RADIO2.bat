...
start chrome --kiosk "http://localhost:1234/radio2.html"
rem start firefox --kiosk "http://localhost:1234/radio.html"
rem start msedge --kiosk "http://localhost:1234/radio.html"
