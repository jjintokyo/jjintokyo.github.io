#!/usr/bin/python3
# -*- coding: utf-8 -*-
# echo "%www-data ALL=NOPASSWD: /home/jj/raspberrypizero2w/my_radio/cpu+temp.sh" | sudo tee -a /etc/sudoers
...
cpu_and_temp   = get_data("/usr/bin/sudo /home/jj/raspberrypizero2w/my_radio/cpu+temp.sh")
